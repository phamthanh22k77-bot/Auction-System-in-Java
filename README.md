...
### 👤 Người 1 — OOP Design & Architecture Lead
...
### ⚙️ Người 2 — Backend, Business Logic & Concurrency
...
### 🌐 Người 3 — Networking & Real-time Communication
...
### 🖥️ Người 4 — Frontend JavaFX & Visualization
...
- **Thuật toán Anti-sniping (Người 2 phụ trách)**: Nếu có bất kỳ người dùng nào đặt giá (`Bid`) ở những giây X cuối cùng của phiên đấu giá, hệ thống tự động **cộng thêm (gia hạn)** thời gian đếm ngược. Mục đích chặn những người dùng rình mò đợi giây cuối mới tung giá (snipers).
...
└── Source/
    └── src/main/java/
        ...
        │   ├── protocol/          
        │   └── utils/             
        └── server/                # Người 1, Người 2, Người 3
