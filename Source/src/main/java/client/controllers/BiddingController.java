 ...
 *
 * Luong su dung:
 * 1. Man hinh truoc (ItemDetail / BidderDashboard) goi setAuction() truoc khi
 * hien
 * 2. initialize() khoi tao BidPriceLineChart + Countdown + Live blink
 * 3. Server (Nguoi 3) goi onBidUpdate() moi khi co bid moi -> cap nhat UI +
 * chart
...
public class BiddingController implements Initializable {
     ...
     * FXMLLoader(getClass().getResource("/client/views/BiddingScreen.fxml"));
